...
<h1><font color="#c00"> Preposition Practice</h1>
...
<form action="/redirectpage" method="post">
    <font color="blue">Your score: {{userscore}} out of 5 <br><br>
    <font color="black">{{paragraphChoice}} <br><br>
    <font color="blue">Here are your answers: {{useranswer1}}, {{useranswer2}}, {{useranswer3}}, {{useranswer4}}, {{useranswer5}} <br>
    <font color="blue">Here are the correct answers: {{', '.join(answers)}} <br>
